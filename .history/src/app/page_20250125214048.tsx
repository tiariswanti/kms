...
export default function Home() {
  useEffect(() => {
    ...
    if (descriptionMetaTag) {
      descriptionMetaTag.setAttribute("content", "Browse through recommendations and more.");
    } else {
    ...
    if (ogTitleMeta) {
      ogTitleMeta.setAttribute("content", "Welcome to KMS KNPK");
    } else {
      const newOgTitleMeta = document.createElement("meta");
      newOgTitleMeta.property = "og:title";
      newOgTitleMeta.content = "Welcome to KMS KNPK";
      document.head.appendChild(newOgTitleMeta);
    }

    const ogDescriptionMeta = document.querySelector('meta[property="og:description"]');
    if (ogDescriptionMeta) {
      ogDescriptionMeta.setAttribute("content", "Browse through recommendations and more.");
    } else {
      const newOgDescriptionMeta = document.createElement("meta");
      newOgDescriptionMeta.property = "og:description";
      newOgDescriptionMeta.content = "Browse through recommendations and more.";
