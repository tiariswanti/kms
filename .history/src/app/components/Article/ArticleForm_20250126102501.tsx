      ...
      <div className="mx-auto w-full">
        ...
        >
          <InputForm
            ...
            error={errors.title} // Menampilkan error
          />
          <InputForm
            label="Author"
            type="text"
            ...
            error={errors.author} // Menampilkan error
          />
          ...
          <TextArea
            ...
            error={errors.summary} // Menampilkan error
          />
          ...
          <TextArea
            ...
            error={errors.references} // Menampilkan error
          />
          <UploadFile
