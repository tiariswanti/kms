      ...
      <div className="flex flex-col sm:flex-row mx-10 md:mx-1 xl:mx-6">
        ...
        <div className="w-full sm:ml-2">
          ...
          <Button
            onClick={onClick}
            type="button"
            classname="group inline-flex items-center h-9 mt-2 rounded-full text-sm font-semibold px-3 bg-gray-300 text-gray-700 hover:bg-primary hover:text-gray-100 focus:outline-none border-none"
          >
            Read more
            <span className="ml-2">
