...
interface CardProps {
  ...
  src: string;
  url: string;
  viewers: number; // Add viewers count as a prop
    ...
    <div className="mb-4">
      <div className="flex flex-col sm:flex-row mx-10 md:mx-1 xl:mx-6">
        <div className="relative h-48 sm:h-52 lg:h-44 overflow-hidden rounded-lg w-full sm:w-[280px] sm:mr-4 lg:mr-6 mb-2 flex-shrink-0">
          ...
          <div className="absolute top-2 left-2 flex items-center bg-gray-900 bg-opacity-60 text-white rounded-full p-2">
            <FaEye size={16} />
            <span className="ml-2 text-sm">{viewers}</span>{" "}
