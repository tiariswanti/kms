  ...
  return (
    <div className="mb-4">
      <div className="flex flex-col sm:flex-row mx-10 md:mx-1 xl:mx-6">
        <div className="h-48 sm:h-52 lg:h-44 overflow-hidden rounded-lg w-full sm:w-[280px] sm:mr-4 lg:mr-6 mb-2 flex-shrink-0">
          <Link href={url} passHref>
            <Image
              ...
              fill
              sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" // Menambahkan prop sizes untuk memberitahu ukuran gambar
              priority
            />
