    ...
    <div className="mb-4">
      <div className="flex flex-col sm:flex-row mx-10 md:mx-1 xl:mx-6">
        ...
        <div className="w-full sm:ml-2">
          ...
          <Button
            onClick={onClick}
            classname="group inline-flex items-center h-9 rounded-full text-sm font-semibold whitespace-nowrap px-3 focus:outline-none  bg-gray-300 text-gray-700 hover:bg-primary hover:text-gray-100 focus:ring-slate-500 mt-3"
          >
            Read more
            <span className="ml-2">
