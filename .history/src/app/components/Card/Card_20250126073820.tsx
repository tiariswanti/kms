        ...
        <div className="relative h-48 sm:h-52 lg:h-44 overflow-hidden rounded-lg w-full sm:w-[280px] sm:mr-4 lg:mr-6 mb-2 flex-shrink-0">
          <Link href={url} passHref>
            <div className="relative w-full h-full">
              {" "}
              {/* Wrapper untuk Image dengan layout fill */}
              <Image
                src={src}
                alt={title}
                layout="fill" // Menggunakan layout fill agar gambar mengisi kontainer
                objectFit="cover" // Menentukan cara gambar mengisi kontainer
                objectPosition="center" // Mengatur posisi gambar
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" // Menentukan ukuran gambar berdasarkan viewport
                priority
              />
            </div>
