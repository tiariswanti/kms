    ...
    <div className="mb-4">
      <div className="flex flex-col sm:flex-row mx-10 md:mx-1 xl:mx-6">
        <div className="relative h-48 overflow-hidden rounded-lg w-full sm:w-[280px] sm:mr-4 lg:mr-6 mb-2 flex-shrink-0">
          ...
          <div className="absolute top-2 left-2 p-2 bg-white rounded-full shadow-md flex items-center">
            <FaEye size={20} className="text-gray-700" />
            <span className="ml-2 text-sm text-gray-700">{viewers}</span> {/* Display viewers count */}
          </div>
        </div>
