...
export default function MainContent({
  ...
  // Determine button alignment based on pathname
  // If the pathname starts with /article, align buttons to the right (justify-end)
  // If the pathname starts with /manage-article, align buttons to the left (justify-start)
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Only display the buttons if on the article or manage-article page */}
