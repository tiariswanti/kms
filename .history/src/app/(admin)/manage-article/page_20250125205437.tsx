...
import Head from "next/head"; // Import Head untuk menambah meta tag
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Search articles by category and query."
        />
        <meta name="robots" content="index, follow" />
        <link rel="icon" href="/favicon.ico" />
        <title>Search Articles</title>
        {/* Dynamic metadata for title and description */}
        <meta property="og:title" content={`Search Articles`} />
        <meta
          property="og:description"
          content={`Search for articles based on your query and category`}
        />
