...
export async function generateMetadata({
  ...
  const title =
    query && category
      ? `Search result for category "${category}" dalam kategori "${category}"`
      : query
  ...
  const description =
    query && category
      ? `Temukan artikel terkait dengan "${query}" dalam kategori "${category}"`
      : query
      ? `Temukan artikel terkait dengan "${query}"`
      : category
      ? `Jelajahi artikel dalam kategori "${category}"`
      : "Jelajahi berbagai artikel terkait topik terbaru";
