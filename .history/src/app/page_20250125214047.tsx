...
export default function Home() {
  useEffect(() => {
    ...
    if (ogTitleMeta) {
      (ogTitleMeta as HTMLElement).setAttribute("content", "Welcome to KMS KNPK");
    } else {
    ...
    if (ogDescriptionMeta) {
      (ogDescriptionMeta as HTMLElement).setAttribute("content", "Browse through recommendations and more.");
    } else {
      const newOgDescriptionMeta = document.createElement("meta");
      newOgDescriptionMeta.setAttribute("property", "og:description");
      newOgDescriptionMeta.setAttribute("content", "Browse through recommendations and more.");
